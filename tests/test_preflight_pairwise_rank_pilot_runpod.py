from scripts.preflight_pairwise_rank_pilot_runpod import pairwise_rank_pilot_config
...
def test_pairwise_rank_pilot_config_sets_new_objective_controls() -> None:
    config = pairwise_rank_pilot_config()
    ...
    assert "--output-root runs/lso_csh_pairwise_rank_pilot" in joined
    assert "--result-doc docs/lso_csh_pairwise_rank_pilot_results.md" in joined
    ...
    assert "--sweep-env LOSS_MODE=recording_pairwise_rank" in joined
...
def test_pairwise_rank_preflight_uses_pairwise_post_run_paths() -> None:
    paths = post_run_output_paths(pairwise_rank_pilot_config())
