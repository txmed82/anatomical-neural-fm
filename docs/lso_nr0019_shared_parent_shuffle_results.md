...
- output root: `runs/lso_nr0019_shared_parent_shuffle`
- sweep env: `SUBJECTS=NR_0019`
...
|---|---|---|---|
| region_only | 3 | -0.008 | 1/3 |
| region_shuffle | 3 | +0.003 | 2/3 |
