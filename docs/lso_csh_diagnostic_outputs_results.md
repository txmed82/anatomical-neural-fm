...
- output root: `runs/lso_csh_diagnostic_outputs`
- sweep env: `SAVE_DIAGNOSTICS=1, EVAL_PREDICTION_MAX_TRIALS=0, REGION_FILTER=shared_regions, REGION_GRANULARITY=parent`
...
No `runs/lso_csh_diagnostic_outputs/summary.md`, `within_summary.md`, or
