...
- sweep script: scripts/run_lso_matched_support80_best6_confirm_a100.sh
- setup mode: project
- skip cell-type priors: False
- skip sweep: False
- startup smoke only: False
- max runtime seconds: 5400
- output root: `runs/lso_matched_support80_best6_confirm`
...
root: `runs/lso_matched_support80_best6_confirm`

## Per-Holdout AUC and Delta vs Shared Null

| holdout | arm | n_seeds | mean_AUC | mean_delta_vs_shared | seed_deltas |
|---|---|---|---|---|---|
| CSH_ZAD_019 | pure_anatomy | 2 | 0.528 | +0.040 | +0.048,+0.032 |
| CSH_ZAD_019 | region_only | 2 | 0.537 | +0.049 | +0.054,+0.044 |
| KS014 | pure_anatomy | 2 | 0.488 | -0.022 | -0.113,+0.069 |
| KS014 | region_only | 2 | 0.519 | +0.009 | -0.061,+0.080 |
| MFD_06 | pure_anatomy | 2 | 0.511 | -0.006 | +0.016,-0.027 |
| MFD_06 | region_only | 2 | 0.514 | -0.002 | +0.018,-0.023 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| pure_anatomy | 6 | +0.004 | 4/6 |
| region_only | 6 | +0.019 | 4/6 |
