...
- output root: `runs/lso_csh_pairwise_rank_pilot`
- sweep env: `SUBJECTS=CSH_ZAD_019, SEEDS=0, BATCH_SAMPLING=recording_target_balanced, LOSS_MODE=recording_pairwise_rank, REGION_SHUFFLE_CONTROL=within_recording_shuffle, BEST_METRIC=full_eval_centered_auc, FULL_EVAL_ON_BEST=1, SAVE_DIAGNOSTICS=1`
...
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.529 | +0.035 | +0.035 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.490 | -0.004 | -0.004 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| region_only | 1 | +0.035 | 1/1 |
| region_shuffle | 1 | -0.004 | 0/1 |
...
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.494 | -0.007 | -0.007 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.474 | -0.027 | -0.027 |

## Full Held-Out-Trial Aggregate Delta vs Shared Null

| arm | n_pairs | mean_full_delta | positive_pairs |
|---|---|---|---|
| region_only | 1 | -0.007 | 0/1 |
