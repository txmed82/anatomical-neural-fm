...
| 2 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 2 --max-builds 2 --allow-partial` |
...
| 5 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 5 --max-builds 2 --allow-partial` |
| 6 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 6 --max-builds 2 --allow-partial` |
...
| 8 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 8 --max-builds 2 --allow-partial` |
| 9 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 9 --max-builds 2 --allow-partial` |
...
| 11 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 11 --max-builds 2 --allow-partial` |
| 12 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 12 --max-builds 2 --allow-partial` |
...
| 14 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 14 --max-builds 2 --allow-partial` |
| 15 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 15 --max-builds 2 --allow-partial` |
...
| 17 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 17 --max-builds 2 --allow-partial` |
| 18 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 18 --max-builds 2 --allow-partial` |
...
| 20 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 20 --max-builds 2 --allow-partial` |
| 21 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 21 --max-builds 2 --allow-partial` |
...
| 23 | 2 | 2 | 0 | `python scripts/build_ibl_brainset_batch.py --manifest manifests/ibl_bwm_region_matched_candidates.json --num-shards 24 --shard-index 23 --max-builds 2 --allow-partial` |
