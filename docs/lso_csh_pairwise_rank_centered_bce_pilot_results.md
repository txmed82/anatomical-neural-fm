...
- output root: `runs/lso_csh_pairwise_rank_centered_bce_pilot`
- sweep env: `SUBJECTS=CSH_ZAD_019, SEEDS=0, BATCH_SAMPLING=recording_target_balanced, LOSS_MODE=recording_pairwise_rank_centered_bce, REGION_SHUFFLE_CONTROL=within_recording_shuffle, BEST_METRIC=full_eval_centered_auc, FULL_EVAL_ON_BEST=1, SAVE_DIAGNOSTICS=1`
...
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.530 | +0.022 | +0.022 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.519 | +0.011 | +0.011 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| region_only | 1 | +0.022 | 1/1 |
| region_shuffle | 1 | +0.011 | 1/1 |
...
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.491 | -0.014 | -0.014 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.509 | +0.004 | +0.004 |

## Full Held-Out-Trial Aggregate Delta vs Shared Null

| arm | n_pairs | mean_full_delta | positive_pairs |
|---|---|---|---|
| region_only | 1 | -0.014 | 0/1 |
...
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.485 | -0.021 | -0.021 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.500 | -0.005 | -0.005 |

## Paired True-vs-Shuffle Trial Gate

| holdout | seed | paired_trials | true_prob_improved | threshold | verdict |
|---|---:|---:|---:|---:|---|
| CSH_ZAD_019 | 0 | 2726 | 0.486 | 0.550 | fail |
