...
- output root: `runs/lso_nr0019_full_eval_centered_shared_parent_shuffle`
- sweep env: `SUBJECTS=NR_0019, FULL_EVAL_ON_BEST=1, SAVE_DIAGNOSTICS=1, BEST_METRIC=full_eval_centered_auc`
...
root: `runs/lso_nr0019_full_eval_centered_shared_parent_shuffle`

## Per-Holdout AUC and Delta vs Shared Null

| holdout | arm | n_seeds | mean_AUC | mean_delta_vs_shared | seed_deltas |
|---|---|---|---|---|---|
| NR_0019 | region_only | 3 | 0.497 | -0.007 | -0.024,-0.002,+0.005 |
| NR_0019 | region_shuffle | 3 | 0.496 | -0.008 | -0.001,-0.010,-0.015 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| region_only | 3 | -0.007 | 1/3 |
| region_shuffle | 3 | -0.008 | 0/3 |
...
|---|---|---|---|---|---|
| NR_0019 | region_only | 3 | 0.494 | -0.005 | -0.011,-0.006,+0.004 |
| NR_0019 | region_shuffle | 3 | 0.497 | -0.001 | -0.002,+0.007,-0.009 |

## Full Held-Out-Trial Aggregate Delta vs Shared Null

| arm | n_pairs | mean_full_delta | positive_pairs |
|---|---|---|---|
| region_only | 3 | -0.005 | 1/3 |
| region_shuffle | 3 | -0.001 | 1/3 |
...
|---|---|---|---|---|---|
| NR_0019 | region_only | 3 | 0.495 | -0.004 | -0.021,-0.002,+0.011 |
| NR_0019 | region_shuffle | 3 | 0.497 | -0.002 | -0.001,+0.007,-0.012 |
