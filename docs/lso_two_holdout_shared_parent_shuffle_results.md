...
root: `runs/lso_two_holdout_shared_parent_shuffle`

## Per-Holdout AUC and Delta vs Shared Null

| holdout | arm | n_seeds | mean_AUC | mean_delta_vs_shared | seed_deltas |
|---|---|---|---|---|---|
| KS014 | region_only | 3 | 0.557 | +0.022 | +0.030,-0.064,+0.099 |
| KS014 | region_shuffle | 3 | 0.527 | -0.008 | +0.011,-0.030,-0.004 |
| MFD_06 | region_only | 3 | 0.506 | +0.010 | +0.043,+0.023,-0.036 |
| MFD_06 | region_shuffle | 3 | 0.492 | -0.003 | -0.001,+0.019,-0.028 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| region_only | 6 | +0.016 | 4/6 |
| region_shuffle | 6 | -0.006 | 2/6 |
