...
- output root: `runs/lso_nyu12_parent_slice`
- sweep env: `SUBJECTS=NYU-12, REGION_FILTER=include_regions, REGION_GRANULARITY=parent, REGION_INCLUDE=PRT,CA,VP,MOp,DG,mfbc`
...
root: `runs/lso_nyu12_parent_slice`

## Per-Holdout AUC and Delta vs Shared Null

| holdout | arm | n_seeds | mean_AUC | mean_delta_vs_shared | seed_deltas |
|---|---|---|---|---|---|
| NYU-12 | region_only | 3 | 0.521 | +0.013 | +0.067,+0.021,-0.048 |
| NYU-12 | region_shuffle | 3 | 0.528 | +0.020 | +0.038,+0.015,+0.007 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| region_only | 3 | +0.013 | 2/3 |
| region_shuffle | 3 | +0.020 | 3/3 |
