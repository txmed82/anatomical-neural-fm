...
| raw probability delta negative fraction | 0.587 |
| target0 true-class improved | 0.580 |
| target1 true-class improved | 0.406 |

## Recording Breakdown

| recording | n | target1_frac | true-shuffle AUC | paired improved | target0 improved | target1 improved | mean raw delta | class |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| `49e0ab27-827a-4c91-bcaa-97eea27a1b8d_probe01` | 777 | 0.467 | -0.027 | 0.468 | 0.391 | 0.556 | +0.001 | `mixed_or_failed_ranking` |
| `5adab0b7-dfd0-467d-b09d-43cb7ca5d59c_probe00` | 590 | 0.414 | -0.043 | 0.414 | 0.000 | 1.000 | +0.008 | `upward_probability_shift` |
| `5adab0b7-dfd0-467d-b09d-43cb7ca5d59c_probe01` | 590 | 0.414 | +0.001 | 0.610 | 0.997 | 0.061 | -0.006 | `downward_probability_shift` |
| `edd22318-216c-44ff-bc24-49ce8be78374_probe00` | 769 | 0.482 | +0.014 | 0.521 | 0.920 | 0.094 | -0.005 | `downward_probability_shift` |
