...
- output root: `runs/lso_swc038_parent_slice`
- sweep env: `SUBJECTS=SWC_038, REGION_FILTER=include_regions, REGION_GRANULARITY=parent, REGION_INCLUDE=PRT,CA,VP,MOp,DG,mfbc`
...
root: `runs/lso_swc038_parent_slice`
