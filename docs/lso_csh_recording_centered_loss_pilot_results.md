...
- sweep env: `SUBJECTS=CSH_ZAD_019, SEEDS=0, BATCH_SAMPLING=recording_target_balanced, LOSS_MODE=recording_centered_bce, BEST_METRIC=full_eval_centered_auc, FULL_EVAL_ON_BEST=1, SAVE_DIAGNOSTICS=1`
...
root: `runs/lso_csh_recording_centered_loss_pilot`

## Per-Holdout AUC and Delta vs Shared Null

| holdout | arm | n_seeds | mean_AUC | mean_delta_vs_shared | seed_deltas |
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.479 | -0.016 | -0.016 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.510 | +0.016 | +0.016 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| region_only | 1 | -0.016 | 0/1 |
| region_shuffle | 1 | +0.016 | 1/1 |
...
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.479 | -0.022 | -0.022 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.512 | +0.011 | +0.011 |

## Full Held-Out-Trial Aggregate Delta vs Shared Null

| arm | n_pairs | mean_full_delta | positive_pairs |
|---|---|---|---|
| region_only | 1 | -0.022 | 0/1 |
...
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.480 | -0.021 | -0.021 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.530 | +0.029 | +0.029 |

## Paired True-vs-Shuffle Trial Gate

| holdout | seed | paired_trials | true_prob_improved | threshold | verdict |
|---|---:|---:|---:|---:|---|
| CSH_ZAD_019 | 0 | 2726 | 0.451 | 0.550 | fail |
