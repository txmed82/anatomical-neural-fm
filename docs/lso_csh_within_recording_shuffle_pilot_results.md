...
- output root: `runs/lso_csh_within_recording_shuffle_pilot`
- sweep env: `SUBJECTS=CSH_ZAD_019, SEEDS=0, REGION_SHUFFLE_CONTROL=within_recording_shuffle, BEST_METRIC=full_eval_centered_auc, FULL_EVAL_ON_BEST=1, SAVE_DIAGNOSTICS=1`
...
root: `runs/lso_csh_within_recording_shuffle_pilot`

## Per-Holdout AUC and Delta vs Shared Null

| holdout | arm | n_seeds | mean_AUC | mean_delta_vs_shared | seed_deltas |
|---|---|---|---|---|---|
| CSH_ZAD_019 | region_only | 1 | 0.553 | +0.027 | +0.027 |
| CSH_ZAD_019 | region_shuffle | 1 | 0.562 | +0.036 | +0.036 |

## Aggregate Delta vs Shared Null

| arm | n_pairs | mean_delta | positive_pairs |
|---|---|---|---|
| region_only | 1 | +0.027 | 1/1 |
| region_shuffle | 1 | +0.036 | 1/1 |
...
| CSH_ZAD_019 | region_shuffle | 1 | 0.530 | +0.019 | +0.019 |
