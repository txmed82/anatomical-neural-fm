...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `49e0ab27-827a-4c91-bcaa-97eea27a1b8d_probe01` | 777 | 0.467 | 0.033 | 0.480 | 0.510 | -0.030 | +0.003 | +0.002 | 0.430 | 1.000 | none |
| `5adab0b7-dfd0-467d-b09d-43cb7ca5d59c_probe00` | 590 | 0.414 | 0.086 | 0.484 | 0.529 | -0.045 | +0.024 | +0.017 | 0.417 | 0.752 | MED, EPI, mfbse |
| `5adab0b7-dfd0-467d-b09d-43cb7ca5d59c_probe01` | 590 | 0.414 | 0.086 | 0.474 | 0.473 | +0.001 | +0.012 | +0.017 | 0.608 | 0.808 | ATN, epsc |
...
| `region_only_vs_shared` | 2726 | 0.458 | -0.002 |
| `region_shuffle_vs_shared` | 2726 | 0.465 | -0.002 |
