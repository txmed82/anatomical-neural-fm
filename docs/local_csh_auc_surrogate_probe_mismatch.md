...
Root: `/Users/colin/Desktop/Projects/anatomical-neural-fm/runs/local_csh_auc_surrogate_probe`
...
| raw probability delta negative fraction | 0.567 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| `49e0ab27-827a-4c91-bcaa-97eea27a1b8d_probe01` | 777 | 0.467 | -0.030 | 0.434 | 0.287 | 0.601 | +0.001 | `mixed_or_failed_ranking` |
| `5adab0b7-dfd0-467d-b09d-43cb7ca5d59c_probe00` | 590 | 0.414 | -0.045 | 0.417 | 0.006 | 1.000 | +0.007 | `upward_probability_shift` |
| `5adab0b7-dfd0-467d-b09d-43cb7ca5d59c_probe01` | 590 | 0.414 | +0.001 | 0.607 | 0.997 | 0.053 | -0.005 | `downward_probability_shift` |
